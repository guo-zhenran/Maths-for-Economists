...
\begin{theorem}
    ...
    \begin{itemize}
        \item upper hemicontinuous if $\varphi^{u} (U)$ is open.
        \item lower hemicontinuous if $\varphi^{l} (U)$ is open.
    \end{itemize}
...
A game is triple $\langle N,\mathcal{A}, \{\preceq_i\}_{i\in N}\rangle$, where
\begin{itemize}
    ...
    \item $\{\preceq_i\}_{i\in N}$ is the set of players' preference.
\end{itemize}
...
To validate the Kakutani's fixed point theorem, we assume $\mathcal{A}_i$ is a nonempt compact convex set and $\preceq_i$ is continuous and quasi-concave on $\mathcal{A}_i$.
\begin{theorem}
    Assume $\mathcal{A}_i$ is a nonempt compact convex set and $\preceq_i$ is continuous and quasi-concave on $\mathcal{A}_i$, there exists a pure-strategy NE.
\end{theorem}
