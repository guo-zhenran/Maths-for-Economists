...
\begin{definition}[Limit Superior and Limit Inferior]
    ...
    $$
    \,We know by definition that they are monotone, thus converge in $\bar{\R}$, whose limit is defined by 
...
We'll show that the converse statement also holds in the next theorem.
\begin{theorem}
