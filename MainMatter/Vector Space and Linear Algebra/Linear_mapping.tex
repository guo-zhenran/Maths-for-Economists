...
\begin{corollary}
    Suppose $\varphi \in \mathcal{L}(V,W)$ with $\dim V = \dim W$, the followings are equivalent:
    \begin{itemize}
        \item $\varphi$ is isomorphic.
        \item $\operatorname{Ker} \varphi$ is trivial.
        \item $\operatorname{Im} \varphi = W$.
        \item $\varphi$ is invertible. 
    \end{itemize}
\end{corollary}
\begin{proof}
