...
%% ============================================================
%% --- Front cover ---
\def\booktitle{Math for Economists}
\def\booksubtitle{A Comprehensive Handbook}
\def\bookedition{Draft Version}
\def\coverimage{cover_graph.pdf}
\def\bookauthors{%
  Zhenran Guo
}
\def\bookpublisher{Please visit \href{https://guo-zhenran.github.io}{guo-zhenran.github.io/} for updates.}

%% --- Back cover ---
\def\bookdescription{%
  This is a handbook of all maths knowledge that economic students need, which contains basics of analysis, algebra, topology and their applications with an emphasis on maths foundations of economic theory.%
}
\def\publisherlogo{logo.png}
\def\bookisbn{Click \href{https://guo-zhenran.github.io/assets/pdf/Maths\%20for\%20Economists.pdf}{here} for updates.}

%% --- Spine ---
\def\spinetitle{Maths for Economists}
\def\spineauthors{Z. Guo}
\def\spineedition{Draft Version}
\def\spinevolume{}
